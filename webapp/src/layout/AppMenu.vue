...
<template>
  <div class="h-full top-[50px] left-0 bottom-0 w-64 bg-surface border-r shadow-sm" v-if="layoutState.sideBarMenuActive">
    <ButtonGroup class="w-full flex flex-col">
      <Button
        ...
        :style="layoutState.activeMenuItem === item ? { backgroundColor: '#f0f0f0' } : {}"
      >
